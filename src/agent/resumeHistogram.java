...
public class resumeHistogram extends histogram{
	HttpSolrServer server;
	public String path;
	
	public resumeHistogram(String path, HttpSolrServer httpServer) throws SolrServerException{
		this.path = path;
		server = httpServer;
		getWordsList();
	...
	private void getWordsList() throws SolrServerException{
		String q = "path:" + path;
